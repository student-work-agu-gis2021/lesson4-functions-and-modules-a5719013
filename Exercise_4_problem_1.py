...
def fahr_to_celsius(temp_fahrenheit):
  """"Explanation of fahr_to_celsius
  This function convert degrees Fahrenheit to degrees Celsius by input temperature.Program parameter is temp_fahrenheit, return value is converted_temp.
  """
